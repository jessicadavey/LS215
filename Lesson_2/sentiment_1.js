...
/*
1. convert text into an array of words
  split on spaces, line breaks, and hyphens
2. loop through array
  if the word matches a word in postiiveWords, increment positive count
  if the word matches a word in negativeWords, increment negative count
3. compare positive to negative to determine overall sentiment
...
function getSentiment(positives, negatives) {
...
function sentiment(text) {
  ...
  console.log(`The sentiment of the text is ${getSentiment(positives, negatives)}.`);
}
